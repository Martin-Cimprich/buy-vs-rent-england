...
or a laptop. It runs the same engine as the paper, not a simplified version, and
`engine.test.mjs` is what backs that claim. Forward-looking break-even analysis, a
2005–2026 historical backtest on the paper's five-year cohort design, and regional presets.
Build it with:
