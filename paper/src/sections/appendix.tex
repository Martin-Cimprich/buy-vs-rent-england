...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{figA1_cashflows}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.78\textwidth]{figA2_regional_map}
  \caption{Forward-looking ten-year required appreciation rate against global equities, by English region, at April 2026 conditions (per cent per year). Darker shading indicates a higher break-even, that is, a market in which buying is harder to justify. Values are those reported in Table~\ref{tab:regional}.}
  \label{fig:rar_map}
\end{figure}
